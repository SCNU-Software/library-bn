...
public class excelController {
    ...
    @ResponseBody
    public resultModel<importExcelRes> importExcel(importExcelReq req) throws Exception {
        ...
        // 无异常正常返回
        resultModel<importExcelRes> res = new resultModel<importExcelRes>(responseEnum.OK,responseEnum.OK_MSG,new ArrayList<importExcelRes>());
        return res;
    }
